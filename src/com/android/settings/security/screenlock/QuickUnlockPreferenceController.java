...
public class QuickUnlockPreferenceController extends AbstractPreferenceController
    ...
    public void updateState(Preference preference) {
        int value = Settings.System.getInt(
                mContext.getContentResolver(), LMOSettings.System.LOCKSCREEN_QUICK_UNLOCK_CONTROL, 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.System.putInt(
                mContext.getContentResolver(), LMOSettings.System.LOCKSCREEN_QUICK_UNLOCK_CONTROL, value ? 1 : 0);
        return true;
    }
